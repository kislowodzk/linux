...
--        awful.util.spawn("xbacklight -inc 15") end),
   ...
   -- ZMIANA KONIEC
    ...
    awful.key({ modkey,           }, "x", function () awful.spawn("nautilus") end,
              {description = "open nautilus", group = "launcher"}),
    awful.key({ modkey,           }, "v", function () awful.spawn("alacritty -e vim") end,
              {description = "open vim", group = "launcher"}),
    awful.key({ modkey,  "Shift"  }, "Return", function () awful.spawn("dmenu_run") end,
              {description = "open dmenu_run", group = "launcher"}),
...
awful.rules.rules = {
    ...
    { rule_any = {type = { "normal", "dialog" }
	  }, properties = { titlebars_enabled = fase } --ZMIANA
    },
...
client.connect_signal("focus", function(c) c.border_color = '#999999' end) -- beautiful.border_focus end)
